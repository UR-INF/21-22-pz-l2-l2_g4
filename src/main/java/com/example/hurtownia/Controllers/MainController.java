...
import com.example.hurtownia.DatabaseQueries.*;
import com.example.hurtownia.PDFGeneration.*;
import com.example.hurtownia.Singleton.SingletonConnection;
import com.example.hurtownia.domain.Customer.KlienciRaport;
import com.example.hurtownia.domain.Customer.Klient;
import com.example.hurtownia.domain.Customer.KlientService;
import com.example.hurtownia.domain.Order.ZamowieniaRaport;
import com.example.hurtownia.domain.Order.Zamowienie;
import com.example.hurtownia.domain.Order.ZamowienieService;
import com.example.hurtownia.domain.OrderItem.ElementZamowieniaService;
import com.example.hurtownia.domain.OrderItem.ElementyZamowieniaRaport;
import com.example.hurtownia.domain.OrderItem.OrderItem;
import com.example.hurtownia.domain.Product.Produkt;
import com.example.hurtownia.domain.Product.ProduktService;
import com.example.hurtownia.domain.Product.ProduktyRaport;
import com.example.hurtownia.domain.Supplier.Dostawca;
import com.example.hurtownia.domain.Supplier.DostawcaService;
import com.example.hurtownia.domain.Supplier.DostawcyRaport;
import com.example.hurtownia.domain.User.Uzytkownik;
import com.example.hurtownia.domain.User.UzytkownikService;
